        ...
        <div className="flex flex-col justify-center">
          ...
          <div className="mt-8 flex flex-wrap gap-4">
            <button
              ...
              className="rounded-2xl bg-black px-8 py-4 text-sm font-medium text-white transition hover:bg-gray-800"
            >
              Add to Cart
            </button>
            ...
            <button
              ...
              className="rounded-2xl border border-gray-300 bg-white px-8 py-4 text-sm font-medium text-gray-700 transition hover:bg-gray-100"
            >
              Buy Now
            </button>
          </div>
